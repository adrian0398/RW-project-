...
title('Velocidad angular de la rueda de reacción n2')
xlabel('pasos')
...
title('Velocidad angular de la rueda de reacción n1')
xlabel('pasos')
ylabel('velocidad angular')
...
title('Velocidad angular de la rueda de reacción n3')
xlabel('pasos')
ylabel('velocidad angular')
